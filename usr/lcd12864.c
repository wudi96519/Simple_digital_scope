...
static Uint16 frambuff[FRAMBUFFERSIZF] = {0};
...
void lcd_Show_Freq_Volt()
{
    ...
    sprintf(msgF,"  Freq :%.2lf %cHz\0",freq,xHz);
    sprintf(msgV,"Voltage:%.2lf V\0",voltege);
    lcd_PutStr(0,0,msgF);
    lcd_PutStr(1,0,msgV);
}
